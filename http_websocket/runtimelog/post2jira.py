...
jira = JIRA('http://192.168.1.118:8080/secure/QuickCreateIssue.jspa?decorator=none', basic_auth=('zhaoyefeng', 'lancelot0318'))

summary = 'auto add id 1'
desc = 'auto add \n id 1'
env = 'env \n id 1'
...
issue_dict = {
    'pid': '10100',
    'issuetype': '1',
    'customfield_10004': 10068,
    'customfield_10003': 10029,
    'summary': summary,
    'versions': 10601,
    'customfield_10002': 10014,
    'customfield_10002:1': 10018,
    'priority': 3,
    'assignee': 'zhaoyefeng',
    'environment': env,
    'description': desc,
